...
public class DoctorDetailsActivity extends AppCompatActivity {
            ...
            private String [][] doctor_details1=
                    {
                            ...
                            {"Doctor Name: Ajit Saste","Hospital Address: Pimpri","Exp : 5yrs","Mobile No:9874632514","600"},
                            {"Doctor Name: Prasdad Pawar","Hospital Address: Nigdi","Exp : 15yrs","Mobile No:15474632514","900"},
                            {"Doctor Name: Swapnil Kale","Hospital Address: Pune","Exp : yrs","Mobile No:2365847514","300"},
                            {"Doctor Name: Deepak Deshmukh","Hospital Address: Chinchwad","Exp : 6yrs","Mobile No:325692514","500"},
                            {"Doctor Name: Ashok Panda","Hospital Address: Katraj","Exp : 7yrs","Mobile No:458632514","800"}
    ...
    private String [][] doctor_details4=
            {
                    ...
                    {"Doctor Name: Amol Gawade","Hospital Address: Pimpri","Exp : 5yrs","Mobile No:9874632514","600"},
                    {"Doctor Name: Prasdad Pawar","Hospital Address: Nigdi","Exp : 15yrs","Mobile No:15474632514","900"},
                    {"Doctor Name: Nilesh Kale","Hospital Address: Pune","Exp : yrs","Mobile No:8898989898","300"},
    ...
    private String [][] doctor_details5=
            {
                    ...
                    {"Doctor Name: Nilesh Borate","Hospital Address: Pimpri","Exp : 5yrs","Mobile No:9857965412","1600"},
                    {"Doctor Name: Pampkaj Pawar","Hospital Address: Nigdi","Exp : 15yrs","Mobile No:15474632514","1900"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv=findViewById(R.id.textViewBuyMedicineTitle);
        Intent it = getIntent();
        ...
        btn=findViewById(R.id.buttonBuyCartMedicineBack);
        ...
        adapter=new SimpleAdapter(this,list,R.layout.multi_lines,
                new String[]{"line1","line2","line3","line4","line5"},
                new int[]{R.id.line_a,R.id.line_b,R.id.line_c,R.id.line_d,R.id.line_e});

        ListView lst =findViewById(R.id.editTextMultilineBuyCartMedicine);
